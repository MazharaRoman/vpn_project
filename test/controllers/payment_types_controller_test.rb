...
class PaymentTypesControllerTest < ActionController::TestCase
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post :create, payment_type: { day: @payment_type.day, month: @payment_type.month, price: @payment_type.price, server_id: @payment_type.server_id, year: @payment_type.year }
    end
  ...
  test "should update payment_type" do
    patch :update, id: @payment_type, payment_type: { day: @payment_type.day, month: @payment_type.month, price: @payment_type.price, server_id: @payment_type.server_id, year: @payment_type.year }
    assert_redirected_to payment_type_path(assigns(:payment_type))
  end
